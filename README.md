...
- **Laptop** — Main PC Control, Server Management
- **Main Computer** — Development, Coding, Sub-agent MCP

### AI / Service Network
- **Server** — ModelNaru, Cresta, Hermes
- **Local AI Machine** — gpt-oss, Gemma, Qwen, LFM
